...
Bus Type:<br><input type="text" name="type" class="ed" style=”text-transform: uppercase;”><br>
Route:<br><input type="text" name="route" class="ed" style=”text-transform: uppercase;”><br>
